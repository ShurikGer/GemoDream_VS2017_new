...
namespace Cntrls
{
	...
	public class OrdersTree : System.Windows.Forms.UserControl
	{	
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OrdersTree));
			...
			this.tvOrders.BeforeExpand += new System.Windows.Forms.TreeViewCancelEventHandler(this.tvOrders_BeforeExpand);
			...
			this.tvOrders.Click += new System.EventHandler(this.tvOrders_Click);
			this.tvOrders.DoubleClick += new System.EventHandler(this.tvOrders_DoubleClick);
			this.tvOrders.MouseClick += new System.Windows.Forms.MouseEventHandler(this.tvOrders_MouseClick);
			// 
			// ilTreeNodes
			// 
			...
			this.ilTreeNodes.Images.SetKeyName(0, "");
			this.ilTreeNodes.Images.SetKeyName(1, "");
			this.ilTreeNodes.Images.SetKeyName(2, "");
			this.ilTreeNodes.Images.SetKeyName(3, "");
			this.ilTreeNodes.Images.SetKeyName(4, "");
			this.ilTreeNodes.Images.SetKeyName(5, "");
			this.ilTreeNodes.Images.SetKeyName(6, "");
			this.ilTreeNodes.Images.SetKeyName(7, "");
			this.ilTreeNodes.Images.SetKeyName(8, "");
			this.ilTreeNodes.Images.SetKeyName(9, "");
			this.ilTreeNodes.Images.SetKeyName(10, "");
			this.ilTreeNodes.Images.SetKeyName(11, "");
			this.ilTreeNodes.Images.SetKeyName(12, "");
			this.ilTreeNodes.Images.SetKeyName(13, "");
			this.ilTreeNodes.Images.SetKeyName(14, "");
			this.ilTreeNodes.Images.SetKeyName(15, "");
			this.ilTreeNodes.Images.SetKeyName(16, "");
			// 
			// OrdersTree
			// 
			this.Controls.Add(this.tvOrders);
			this.Name = "OrdersTree";
			this.Size = new System.Drawing.Size(655, 185);
			this.Resize += new System.EventHandler(this.OrdersTree_Resize);
		...
		private void tvOrders_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e)
		{
			...
			var nodeCode = ((OrderNode)e.Node).NodeCode;
...
*/
		...
		protected virtual void tvOrders_AfterCheck(object sender, TreeViewEventArgs e)
		{
			var a = e.Node.Level;
			var b = e.Node.Checked;
			var nodeCode = ((OrderNode)e.Node).NodeCode;
		...
		[Browsable(true)]
		public event TreeViewEventHandler AfterExpand;
		private void tvOrders_AfterExpand(object sender, TreeViewEventArgs e)
		{
			var a = e.Node.Level;
			var b = e.Node.Checked;
			var nodeCode = ((OrderNode)e.Node).NodeCode;
		...
		private void tvOrders_Click(object sender, EventArgs e)
		{
			var a = 0;
		}

		private void tvOrders_BeforeExpand(object sender, TreeViewCancelEventArgs e)
		{
			var a = e.Node.Level;
			var b = e.Node.Text;
		}

		private void tvOrders_MouseClick(object sender, MouseEventArgs e)
		{
			var a = 0;
		}
	}
	...
	{			
		...
		*/
		...
		public OrderNode(DataRow drData, bool bShowColorAndClarity):base(drData["Name"].ToString())
		{
			if (drData.Table.TableName == "tblOrder") 
				...
				try
				{
					...
					if (drData["Memo"] != DBNull.Value)
					{
						if (drData["Memo"].ToString().Trim() != "")
							this.Text = this.Text + " (M: " + drData["Memo"].ToString().Trim() + ")";
					}
				}
				catch {}
			...
			if (drData.Table.TableName == "tblBatch") 
				...
				try
				{
					if (drData["MemoNumber"] != DBNull.Value)
					{
						if (drData["MemoNumber"].ToString().Trim() != "")
							this.Text = this.Text + " (M: " + drData["MemoNumber"].ToString().Trim() + ")";
					}
				}
				catch{}
			}
			if (drData.Table.TableName == "tblItem" && bShowColorAndClarity)
			...
			if (drData.Table.TableName == "tblMemo") 
			{
				try
				{
					this.Text = "Memo: " + this.Text;
					if (drData["ItemsQuantity"] != DBNull.Value)
						this.Text = this.Text +  " (" + drData["ItemsQuantity"].ToString() + " pcs)";
					if (drData["nBatches"] != DBNull.Value)
						this.Text = this.Text +  " (Batches in Memo: " + drData["nBatches"].ToString() + ")";
				}
				catch{}
			}
			Initialize(drData);
