...
{
	/// <summary>
	/// Summary description for OrderTreeByMemo.
	/// </summary>
		
	public class OrderTreeByMemo : System.Windows.Forms.UserControl
	{	
		public struct TableList 
		{
			...
			public static string[] Memo = {"6","tblMemo"};
		} ;
		public static string[] TableNames = {"tblItem","tblBatch","tblMemo","tblOrder","tblCustomer","tblDocument"};
		// I hate static and const field
		public static int GetTableCode1(string tblName)
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(OrderTreeByMemo));
		...
		{	
			...
			if ((IsDocumentGhost1) && (row.Table.TableName == "tblDocument"))
			{
				node.IsGhost=true;
			}
	...
	{			
		...
		*/
		...
		private void Initialize(DataRow drData)
		{
			...
			tblCode = OrderTreeByMemo.GetTableCode1(tblName);
