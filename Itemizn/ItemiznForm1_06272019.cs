...
namespace gemoDream
{
	...
	public class Itemizn1Form : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.rbBatchLabelsPrint.CheckedChanged += new System.EventHandler(this.rbBatchLabelsPrint_CheckedChanged);
            // 
            // btnClearSet
            // 
...
////						nonNumberEntered = true;
								...
								ref		System.Windows.Forms.StatusBar Itemizn2Status)
		{
			...
			try
			{
				...
				outList = Service.Itemizn2_BatchAdd(dvItems, 
		...
		private void Print()
		{
			Print(alThreadPrintParam);
		}

		private void Print(ArrayList outList)
		{
//#if DEBUG
//			return;
//#endif
...
//				{
					try
					{
						...
						if(rbItemLabelsRegular.Checked)
							...
							crReport_Label.Excel_Tag_Item(outList[0].ToString() + "_0");
					}
					catch(Exception ex)
					{
						MessageBox.Show(this,ex.Message,"Print error",MessageBoxButtons.OK,MessageBoxIcon.Error); 
...
//				}
			...
			//			crInternal_Receipt_Report.Internal_Receipt(outList[0].ToString());
...
//                sGroup = bcItem.sGroupCode;
        ...
        private void rbBatchLabelsPrint_CheckedChanged(object sender, EventArgs e)
        {
